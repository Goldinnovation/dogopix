...
const handleUploadGifUrlToDB = async (cloudFileURL: string, req: AuthenticatedRequest, res: Response) => {
...
const processUserBackgroundGifImage = async (req: AuthenticatedRequest, res: Response) => {
  try {
    if (!req.file) {
    ...
    const downloadURL = await uploadFileToFirebase(storageRef, compromiseGifData, metadata, req, res);
...
const handleSetPlayerBackground = async (req: Request, res: Response) => {
  ...
  // console.log('request', req.body);
    ...
    await processUserBackgroundGifImage(req as AuthenticatedRequest, res);
